...
public class ChessBishopMiniTest extends ChessPieceTest {
	...
	@Override
	protected ChessBishopMini addPiece(final Position position, final ChessColor color) {
		final ChessBishopMini piece = new ChessBishopMini(board, color);
		if (position != null) {
	...
	public void testBishopMiniNormal() {
		...
		assertTrue(bishop.canMove(new Position(3, 4)));
		assertTrue(bishop.canMove(new Position(4, 3)));
		assertTrue(bishop.canMove(new Position(3, 2)));
		assertTrue(bishop.canMove(new Position(2, 3)));
	}

	@Test
	public void testBishopMiniTeamBlocked() {
		final ChessBishop bishop = addPiece(new Position(3, 3), ChessColor.WHITE);
	...
	@Test
	public void testBishopMiniAttack() {
		final ChessBishop bishop = addPiece(new Position(3, 3), ChessColor.WHITE);
		...
		assertFalse(bishop.canMove(new Position(3, 4)));
		assertFalse(bishop.canMove(new Position(4, 3)));
		assertFalse(bishop.canMove(new Position(3, 2)));
		assertFalse(bishop.canMove(new Position(2, 3)));
	}
}
