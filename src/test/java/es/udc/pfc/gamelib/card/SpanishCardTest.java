...
public class SpanishCardTest {
	...
	@Test(expected = IllegalArgumentException.class) public void testConstructorRange() {
		new SpanishCard(SpanishCard.SpanishSuit.Oros, 14);
	}
	
	@Test(expected = IllegalArgumentException.class) public void testConstructorNegative() {
